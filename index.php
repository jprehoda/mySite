...
<body ng-app="joesApp" ng-controller="bodyCtrl" ng-class="{'alt-layout':switchLayout}" ng-click="checkNav($event)">
	<header>
		<nav>
			...
			<div id="slide-nav" ng-class="{'nav-clicked':isNavOpen}" ng-style="{height: navHeightOffset()}">
				<ul>
					<li class="raleway"><a href="/#hero-background" ng-click="gotoElement('hero-background', $event)" tabindex="2"><img src="/site15/assets/nav_icon_home.png" alt="" role="presentation" /><span>Home</span></a></li>
					<li class="raleway"><a href="/#about-text" tabindex="3" ng-click="gotoElement('about-text', $event)"><img src="/site15/assets/nav_icon_book.png" alt="" role="presentation" /><span>About</span></a></li>
					<li class="raleway"><a href="/#skill-text" tabindex="4" ng-click="gotoElement('skill-text', $event)"><img src="/site15/assets/nav_icon_know.png" alt="" role="presentation" /><span>Development Skills</span></a></li>
					<li class="raleway"><a href="https://github.com/jprehoda" tabindex="5"><img src="/site15/assets/nav_icon_code.png" alt="" role="presentation" /><span>Code Snippets</span></a></li>
					<li class="raleway"><a href="#" ng-click="showContactForm($event)" tabindex="6"><img src="/site15/assets/nav_icon_mail.png" alt="" role="presentation" /><span>Contact</span></a></li>
					<li class="raleway"><a href="https://www.linkedin.com/in/joe-prehoda-8040a325" tabindex="7"><img src="/site15/assets/nav_icon_linkedin.png" alt="" role="presentation" /><span>LinkedIn</span></a></li>
					<li class="raleway"><a href="#" tabindex="8" ng-class="{active-nav-item: set-nav-item-active}" ng-mouseenter="set-nav-item-active = true" ng-mouseleave="set-nav-item-active = false" ng-click="set-nav-item-active = !set-nav-item-active" ><img src="/site15/assets/nav_icon_linkedin.png" alt="" role="presentation" /><span>Archive</span></a>
						<ul>
							<li class="raleway"><a herf="/2009/index.html" tabindex="9">2009 Site</a></li>
							<li class="raleway"><a herf="/2011/index.html" tabindex="10">2009 Site</a></li>
						</ul>
					</li>
	...
	<section id="hero-background" class="hide-tp">
		<img src="/site15/assets/spacer.gif" src="/site15/assets/family_hero.jpg" role="presentation" alt="" />
		<img class="alt-hero" data-src="/site15/assets/solo_hero.jpg" role="presentation" alt="" />
	</section>
			...
			<div class="relative-element">
				<?php
					if ($response != null && $response->success) {
						...
						echo '<p class="raleway contact-thank-you">Thank you '.$_POST['contact-name'].' for contacting me.<br />I should be contacting you shortly. <br /><a href="#" tabindex="100" ng-click="showContactForm($event)">Close</a><p>';
	...
	<section id="hp-hero">
		...
		<div class="responsive-wrapper hero-wrapper float-wrapper wrapper-large">
			...
			<div class="float-wrapper">
				<div class="nav-bucket" ng-click="gotoElement('about-text', $event)" tabindex="30">
				...
				<div class="nav-bucket" ng-click="gotoElement('what-i-know-section', $event)" tabindex="31">
	...
	<footer class="wrapper_small float-wrapper">
		...
		<p class="float-right raleway">
			<a href="#" ng-click="showContactForm($event)" tabindex="37">Contact Me</a>
