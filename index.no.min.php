		...
		<nav>
			...
			<div id="slide-nav" ng-class="{'nav-clicked':isNavOpen}" ng-style="{height: navHeightOffset()}">
				<ul>
					...
					<li class="raleway no-nav-check"><a href="#" tabindex="8" class="no-nav-check" ng-class="{'active-nav-item':setNavItemActive}" ng-click="setNavItemActive = !setNavItemActive" ><img src="/site15/assets/nav_icon_archive.png" alt="" role="presentation" class="no-nav-check" /><span class="no-nav-check">Archive</span></a>
						<ul>
							<li class="raleway"><a class="no-nav-check" href="/2009/index.html" tabindex="9"><img src="/site15/assets/arrow.png" alt="" role="" /><span class="no-nav-check">2009 Muddy Site</span></a></li>
							<li class="raleway"><a class="no-nav-check" href="/2011/index.html" tabindex="10"><img src="/site15/assets/arrow.png" alt="" role="" /><span class="no-nav-check">2011 Heavy Design Site</span></a></li>
						</ul>
					</li>
				</ul>
			</div><!-- End #slideNav -->
